<div>
    <div class="mb-4 flex flex-col md:flex-row md:items-center justify-between">
        ...
        <div class="flex items-center space-x-2">
            ...
            <a href="<?php echo e(route('transactions.create', ['type' => 'income'])); ?>" class="btn btn-sm btn-primary">
                ...
                <tbody class="table-body">
                    <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr class="table-row">
                            ...
                            <td class="table-cell font-medium text-green-600"><?php echo e('R$ ' . number_format($transaction->amount/100, 2, ',', '.')); ?></td>
                            <td class="table-cell">
    ...
    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</div> <?php /**PATH /var/www/html/onlifin/resources/views/livewire/transactions/income.blade.php ENDPATH**/ ?>