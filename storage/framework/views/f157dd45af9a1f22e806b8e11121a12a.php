                ...
                <form action="<?php echo e(route('settings.appearance.update')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <?php if($siteLogo): ?>
                                <img src="<?php echo e(asset($siteLogo)); ?>" alt="Logo Atual" class="h-12">
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="mb-6">
                        ...
                        <select name="site_theme" id="site_theme"
                            ...
                            <option value="light" <?php echo e(old('site_theme', $siteTheme) === 'light' ? 'selected' : ''); ?>>Claro</option>
                            <option value="dark" <?php echo e(old('site_theme', $siteTheme) === 'dark' ? 'selected' : ''); ?>>Escuro</option>
                        </select>
