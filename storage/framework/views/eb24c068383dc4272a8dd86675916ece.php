                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="type" id="type" class="form-select block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" onchange="updateCategories(this.value)">
                                <option value="income" <?php echo e(old('type', $type ?? '') == 'income' ? 'selected' : ''); ?>>Receita</option>
                                <option value="expense" <?php echo e(old('type', $type ?? '') == 'expense' ? 'selected' : ''); ?>>Despesa</option>
                            </select>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="description" id="description" 
                                class="form-input block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                value="<?php echo e(old('description')); ?>" placeholder="Ex: Salário, Aluguel, etc">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php if(old('type', request()->type) == 'income'): ?>
                    ...
                    <?php elseif(old('type', request()->type) == 'expense'): ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="notes" id="notes" rows="3" 
                            ...
                            placeholder="Observações adicionais (opcional)"><?php echo e(old('notes')); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="status" class="form-select" required>
                            <option value="pending" <?php echo e(old('status') === 'pending' ? 'selected' : ''); ?>>Pendente</option>
                            <option value="paid" <?php echo e(old('status') === 'paid' ? 'selected' : ''); ?>>Pago</option>
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="recurrence_type" id="recurrence_type" class="form-select block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" onchange="toggleRecurrenceFields()">
                            <option value="none" <?php echo e(old('recurrence_type') === 'none' ? 'selected' : ''); ?>>Nenhuma</option>
                            <option value="fixed" <?php echo e(old('recurrence_type') === 'fixed' ? 'selected' : ''); ?>>Fixa</option>
                            <option value="installment" <?php echo e(old('recurrence_type') === 'installment' ? 'selected' : ''); ?>>Parcelada</option>
                        </select>
                    </div>
                    ...
                    <div id="installment-fields" class="grid grid-cols-1 md:grid-cols-2 gap-6" style="display: none;">
                        <div class="form-group">
                            ...
                            <input type="number" name="installment_number" id="installment_number" 
                                class="form-input block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                value="<?php echo e(old('installment_number', 1)); ?>" min="1">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="total_installments" id="total_installments" 
                                class="form-input block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                                value="<?php echo e(old('total_installments', 12)); ?>" min="1">
                        </div>
                    </div>
                    ...
                    <div id="next-date-field" class="form-group" style="display: none;">
                        ...
                        <input type="date" name="next_date" id="next_date" 
                            class="form-input block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                            value="<?php echo e(old('next_date', date('Y-m-d', strtotime('+1 month')))); ?>">
                    </div>
                </div>
...
<?php endif; ?><?php /**PATH /var/www/html/onlifin/resources/views/transactions/create.blade.php ENDPATH**/ ?>