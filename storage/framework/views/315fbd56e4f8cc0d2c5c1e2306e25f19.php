        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div class="card hover:shadow-md transition-shadow">
                <div class="p-6">
                    ...
                    <a href="<?php echo e(route('profile.edit')); ?>" class="btn btn-secondary w-full">
                        Editar Perfil
                    </a>
                </div>
            </div>
            ...
            <div class="card hover:shadow-md transition-shadow">
                <div class="p-6">
                    ...
                    <a href="<?php echo e(route('settings.notifications.index')); ?>" class="btn btn-secondary w-full">
            ...
            <div class="card hover:shadow-md transition-shadow">
                <div class="p-6">
                    ...
                    <a href="<?php echo e(route('settings.users')); ?>" class="btn btn-secondary w-full">
                        Gerenciar Usuários
                    </a>
                </div>
            </div>
            ...
            <div class="card hover:shadow-md transition-shadow">
                <div class="p-6">
                    ...
                    <a href="<?php echo e(route('settings.roles')); ?>" class="btn btn-secondary w-full">
                        Gerenciar Perfis
                    </a>
                </div>
            </div>
            ...
            <div class="card hover:shadow-md transition-shadow">
                <div class="p-6">
                    ...
                    <a href="<?php echo e(route('settings.reports')); ?>" class="btn btn-secondary w-full">
            ...
            <div class="card hover:shadow-md transition-shadow">
                <div class="p-6">
                    ...
                    <a href="<?php echo e(route('settings.backup')); ?>" class="btn btn-secondary w-full">
                        Gerenciar Backup
                    </a>
                </div>
            </div>
            ...
            <div class="card hover:shadow-md transition-shadow">
                <div class="p-6">
                    ...
                    <a href="<?php echo e(route('settings.system')); ?>" class="btn btn-secondary w-full">
                        Acessar Atualização
                    </a>
                </div>
            </div>
            ...
            <div class="card hover:shadow-md transition-shadow">
                <div class="p-6">
                    ...
                    <a href="<?php echo e(route('openrouter-config.index')); ?>" class="btn btn-secondary w-full">
                        Configurar IAs
                    </a>
                </div>
            </div>
            ...
            <div class="card hover:shadow-md transition-shadow">
                <div class="p-6">
                    ...
                    <a href="<?php echo e(route('settings.logs.index')); ?>" class="btn btn-secondary w-full">
                        Visualizar Logs
                    </a>
                </div>
            </div>
    ...
    <div class="mt-8 pt-8 border-t border-gray-200">
        ...
        <div class="card bg-yellow-50 border-yellow-200">
            <div class="card-body">
                ...
                <p class="text-sm text-yellow-700 mb-4">
                    <strong>Atenção (Dev):</strong> Esta ação apagará permanentemente todas as transações, contas e categorias associadas ao <strong class="font-bold">seu usuário atual (<?php echo e(auth()->user()->email); ?>)</strong>. Use com cuidado.
                </p>
                
                <form method="POST" action="<?php echo e(route('settings.deleteUserData')); ?>" onsubmit="return confirm('Tem certeza que deseja apagar TODOS os dados financeiros deste usuário (transações e categorias)? Esta ação não pode ser desfeita!');">
                    <?php echo csrf_field(); ?>
        ...
        <div class="card bg-yellow-50 border-yellow-200 mt-4">
            <div class="card-body">
                ...
                <form method="POST" action="<?php echo e(route('settings.deleteUserData')); ?>" id="deleteSpecificUserForm">
                     <?php echo csrf_field(); ?>
                     <?php echo method_field('DELETE'); ?>
                     <div class="mb-4">
                         ...
                         <select name="user_id" id="specific_user_id" class="form-select w-full md:w-1/2" required>
                             ...
                             <?php $__currentLoopData = $usersForDeletion; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
</script><?php /**PATH /var/www/html/onlifin/resources/views/settings/index.blade.php ENDPATH**/ ?>