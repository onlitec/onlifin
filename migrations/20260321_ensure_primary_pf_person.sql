-- ===========================================
-- 2026-03-21 - Pessoa titular PF automatica e protegida
-- ===========================================
-- Objetivos:
-- 1. Garantir que signup_tenant crie a pessoa titular PF automaticamente
-- 2. Persistir owner_person_id e hide_titular em profiles.settings
-- 3. Backfill de perfis antigos sem pessoa PF padrao
