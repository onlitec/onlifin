...
class NotificationSettingsModal extends ModalComponent
{
    public $user;
    ...
    protected function loadSettings()
    {
        ...
        $this->whatsappNotifications = $this->user->whatsapp_notifications ?? false;
        
        // Carregar configurações avançadas
        $settings = NotificationSetting::where('user_id', $this->user->id)->first();
        if ($settings) {
            ...
            $this->whatsappProvider = config('notification-channels.whatsapp.default', 'twilio');
        }
    ...
    public function saveSettings()
    {
        $this->validate([
            ...
            'whatsappProvider' => 'nullable|string',
        ]);
        ...
        $this->user->update([
            ...
            'whatsapp_notifications' => $this->whatsappNotifications,
            'phone' => $this->phone,
        ]);
    ...
    {
        return view('livewire.notification-settings-modal');
    }
