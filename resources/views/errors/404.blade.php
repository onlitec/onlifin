...
<head>
    ...
    <title>Página Não Encontrada - Onlifin</title>
...
<body class="antialiased">
    <div class="min-h-screen flex flex-col justify-center items-center p-4">
        <div class="error-container">
            ...
            <img src="{{ asset('assets/images/404-illustration.svg') }}" alt="Página não encontrada" class="error-image" onerror="this.style.display='none'">
