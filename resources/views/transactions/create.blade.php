        ...
        <div class="card" style="width: 100%; max-width: 100%; overflow: visible; position: relative;">
            <form action="/transactions" method="POST" id="transaction-form">
                ...
                <div class="card-body p-4 space-y-4" style="width: 100%; overflow-x: hidden; overflow-y: visible;">
                    @if(($type ?? '') === 'transfer')
                        <!-- Campos ocultos para transferência -->
                        <input type="hidden" name="type" value="transfer">
                        <input type="hidden" name="is_transfer" value="1">
                        <!-- Formulário de Transferência Melhorado -->
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <!-- Data -->
                            <div class="form-group">
                                <label for="date" class="block text-sm font-medium text-gray-700 mb-1">Data</label>
                                <input type="date" name="date" id="date" class="form-input block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" value="{{ old('date', date('Y-m-d')) }}">
                                @error('date')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                            </div>
                            <!-- Valor -->
                            <div class="form-group">
                                <label for="amount_display" class="block text-sm font-medium text-gray-700 mb-1">Valor</label>
                                <div class="relative">
                                    <input type="text" name="amount_display" id="amount_display" class="form-input block w-full pl-3 rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" placeholder="R$ 0,00" inputmode="decimal">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="description" id="description" class="form-input block w-full rounded-lg border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500" value="{{ old('description') }}" placeholder="Ex: Salário, Aluguel, etc">
                                @error('description')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                            </div>
                            <!-- Conta de Destino -->
                            <div class="form-group">
                                <label for="transfer_to_account_id" class="block text-sm font-medium text-gray-700 mb-1">Conta&nbsp;de&nbsp;Destino</label>
                                <select name="transfer_to_account_id" id="transfer_to_account_id" class="form-select bg-white dark:bg-gray-800 block w-full rounded-lg shadow-sm border-gray-300 dark:border-gray-600 focus:border-blue-500 focus:ring-blue-500">
                                ...
                                @error('transfer_to_account_id')<p class="mt-1 text-sm text-red-600">{{ $message }}</p>@enderror
                            </div>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <!-- Categoria -->
                            <div class="form-group">
                                ...
                                <select name="category_id" id="category_id" class="form-select bg-white dark:bg-gray-800 block w-full rounded-lg shadow-sm border-gray-300 dark:border-gray-600 focus:border-blue-500 focus:ring-blue-500">
                            ...
                            <!-- Conta de Origem -->
                            <div class="form-group">
                                <label for="account_id" class="block text-sm font-medium text-gray-700 mb-1">Conta&nbsp;de&nbsp;Origem</label>
                                <select name="account_id" id="account_id" class="form-select bg-white dark:bg-gray-800 block w-full rounded-lg shadow-sm border-gray-300 dark:border-gray-600 focus:border-blue-500 focus:ring-blue-500">
                        ...
                        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end space-x-3 rounded-b-xl">
                            ...
                            <button type="submit" class="btn btn-primary"><i class="ri-save-line mr-2"></i> Salvar Transferência</button>
                        </div>
                    @else
                        <!-- Tipo e Data -->
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <!-- Botões padrão (padrão = Salvar Transação) -->
                        <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end space-x-3 rounded-b-xl">
                            <a href="{{ $type === 'income' ? route('transactions.income') : route('transactions.expenses') }}" class="btn btn-secondary">Cancelar</a>
                            <button type="submit" class="btn btn-primary"><i class="ri-save-line mr-2"></i>Salvar Transferência</button>
                        </div>
                    @endif
                </div>
