    ...
    <div class="container-app">
        ...
        <div class="mb-4">
            <nav class="flex space-x-4 text-sm">
                <a href="{{ route('transactions.index', ['filter'=>'all']) }}" class="pb-1 {{ $filter=='all' ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-600 hover:text-gray-800' }} dark:text-white dark:hover:text-white">Todos</a>
                <a href="{{ route('transactions.index', ['filter'=>'income']) }}" class="pb-1 {{ $filter=='income' ? 'border-b-2 border-blue-600 text-blue-600' : 'text-gray-600 hover:text-gray-800' }} dark:text-white dark:hover:text-white">Receitas</a>
