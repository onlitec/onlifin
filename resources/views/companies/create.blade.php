<x-app-layout>
    {{-- Início do formulário de nova Empresa --}}
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            ...
            <form action="{{ route('companies.store') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                @csrf
                <div class="mb-4">
                ...
                <div class="mb-6">
                    ...
                    <select class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                        ...
                        @foreach(\App\Enums\Setting\EntityType::cases() as $type)
                            <option value="{{ $type->value }}" {{ old('entity_type') == $type->value ? 'selected' : '' }}>
                                {{ $type->value }}
                            </option>
                        @endforeach
                    </select>
