    ...
    <div class="container-app">
        <div class="mb-6">
            <div class="flex items-center gap-2 mb-2">
                ...
                <h1 class="text-2xl font-bold text-gray-900">Configurações de Notificações Push</h1>
            </div>
            <p class="mt-1 text-sm text-gray-600">Configure as notificações push para enviar alertas diretamente no navegador dos usuários</p>
        </div>
